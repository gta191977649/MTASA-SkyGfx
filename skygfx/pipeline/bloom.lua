...
function initBloom()
	...
	blurHShader,tecName = dxCreateShader( "shader/blurH.fx" )
	outputDebugString( "blurHShader is using technique " .. tostring(tecName) )

	blurVShader,tecName = dxCreateShader( "shader/blurV.fx" )
	outputDebugString( "blurVShader is using technique " .. tostring(tecName) )

	brightPassShader,tecName = dxCreateShader( "shader/brightPass.fx" )
	outputDebugString( "brightPassShader is using technique " .. tostring(tecName) )

    addBlendShader,tecName = dxCreateShader( "shader/addBlend.fx" )
...
addEventHandler( "onClientHUDRender", root,
    function()
		...
		if current then
			dxSetShaderValue( addBlendShader, "src", current )
