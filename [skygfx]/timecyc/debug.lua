...
label_oldWea = dgsCreateLabel(0.4, 0.04, 0.01, 0.1, "CURRENT WEATHER: "..Weather.old, true,debugWin)
input_oldWea = dgsCreateEdit( 0.4, 0.1, 0.25, 0.1, Weather.old, true,debugWin)
label_nextWea = dgsCreateLabel(0.7, 0.04, 0.01, 0.1, "BLEND WEATHER: "..Weather.new, true,debugWin)
...
function updateUI() 
    ...
    dgsSetProperty(label_oldWea,"text",string.format("CURRENT WEATHER: %d",Weather.old))
    dgsSetProperty(label_nextWea,"text",string.format("BLEND WEATHER: %d",Weather.new))
end
